...
| TokenType    | int8     | 1 for tiny token and 2 for Mini-BEP2 token. Total supply range of tiny token is [1-10K] and mini-token is [1, 100K]. Mini-token will charge more than tiny-token for issue. |
