...
# BEP-656: Implement EIP-7910: eth_config JSON-RPC Method

- [BEP-656: Implement EIP-7910: eth\_config JSON-RPC Method](#bep-656-implement-eip-7910-eth_config-json-rpc-method)
  - [1. Summary](#1-summary)
  ...
  - [4. Rationale](#4-rationale)
    - [Why Three Time Horizons?](#why-three-time-horizons)
    - [Why Not Include All Future Forks?](#why-not-include-all-future-forks)
