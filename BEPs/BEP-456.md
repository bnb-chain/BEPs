...
Since the technology is too complex, the specific implementation is beyond the scope of this BEP. Here are some [open source projects](https://consensys.github.io/smart-contract-best-practices/security-tools/static-and-dynamic-analysis/) for reference. Due to the complexity and dynamism of smart contract execution, the prediction results of static analysis are not always completely accurate, and there are errors and omissions in read-write sets.
