...
# BEP-654: Implement EIP-7939: Count Leading Zeros (CLZ) Opcode

- [BEP-654: Implement EIP-7939: Count Leading Zeros (CLZ) Opcode](#bep-654-implement-eip-7939-count-leading-zeros-clz-opcode)
  - [1. Summary](#1-summary)
  - [2. Motivation](#2-motivation)
  - [3. Specification](#3-specification)
  - [4. Rationale](#4-rationale)
    - [The Special Zero Case](#the-special-zero-case)
    - [Preference over `CTZ` (Count Trailing Zeros)](#preference-over-ctz-count-trailing-zeros)
    - [Gas Cost](#gas-cost)
