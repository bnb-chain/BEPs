...
- [BEP-364: Primary Storage Provider acts as the upload agent for object creation and update on Greenfield](#bep-364-primary-storage-provider-acts-as-the-upload-agent-for-object-creation-and-update-on-greenfield)
  ...
  - [4. Specification](#4-specification)
    - [4.1 APIs](#41-apis)
      - [4.1.1 SP APIs](#411-sp-apis)
        - [SDK](#sdk)
      - [4.1.2 Greenfield Chain New Messages](#412-greenfield-chain-new-messages)
    - [4.2 New workflow for object creation/update on Greenfield](#42-new-workflow-for-object-creationupdate-on-greenfield)
