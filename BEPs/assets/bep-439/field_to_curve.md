# Field element to curve point mapping used by BEP-439

For a BLS12-381 implemented by BEP-439 a short Weierstrass curve equation y^2 = x^3 + A * x + B has a property that a product AB = 0, so to implement a mapping function two step algorithms is performed:
