<pre>
  BEP: 414
  Title: EOA based Paymaster API Spec
  Status: Draft
  Type: Standards
  Created: 2024-07-23
</pre>

# BEP-414: EOA based Paymaster API Spec
...
- `result`: Return error if no matched policy is found or return an object containing the matched sponsorship policy details:
...
```json
{
  ...
  "result": {
    ...
    "sponsorName": "Nodereal Ltd.",
    "sponsorIcon": "https://www.nodereal.io/static/nodereal/images/favicon.ico",
    "sponsorWebsite": "https://nodereal.io/"
  }
}
```
Failure Response:
...
```json
{
    ...
    "error": {
        "code": -32000,
        "message": "can not found a matching policy"
    }
}
```
