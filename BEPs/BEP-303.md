<pre>
  BEP: 303
  Title: Implement EIP-3860: Limit and meter initcode
  Status: Draft
  Type: Standards
  Created: 2023-10-27
</pre>

# BEP-303: Implement EIP-3860: Limit and meter initcode
- [1. Summary](#1-summary)
...
- [5. Rationale](#5-rationale)
  - [Gas cost constant](#gas-cost-constant)
  - [Gas cost per word (32-byte chunk)](#gas-cost-per-word-32-byte-chunk)
  - [Reason for size limit of initcode](#reason-for-size-limit-of-initcode)
  - [Effect of size limit of initcode](#effect-of-size-limit-of-initcode)
  - [Initcode cost for create transaction](#initcode-cost-for-create-transaction)
  - [How to report initcode limit violation?](#how-to-report-initcode-limit-violation)
