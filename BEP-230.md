...
# BEP-230: Implement EIP-2929 Gas cost increases for state access opcodes
- [BEP-230: Implement EIP-2929 Gas cost increases for state access opcodes](#bep-230-implement-eip-2929-gas-cost-increases-for-state-access-opcodes)
  - [1. Summary](#1-summary)
...
## 1. Summary
As part of Berlin upgrade, EIP-2929 Gas cost increases for state access opcodes is required to be implemented to BSC.
