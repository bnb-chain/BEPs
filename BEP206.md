...
- [BEP-206: Hybrid Mode State Expiry](#bep-206-hybrid-mode-state-expiry)
  - [1. Summary](#1-summary)
  - [2. Motivation](#2-motivation)
  - [3. Specification](#3-specification)
    - [3.1.Hierarchy View](#31hierarchy-view)
      - [a.Current MPT Tree](#acurrent-mpt-tree)
      - [b.Hybrid Mode MPT Tree](#bhybrid-mode-mpt-tree)
      - [c.Hybrid Mode: Storage Trie Expire](#chybrid-mode-storage-trie-expire)
...
#### c.Hybrid Mode: Storage Trie Expire
...
![3_hybrid_mode_expired](./assets/bep-206/3_hybrid_mode_expired.png)
...
![5_stub_node](./assets/bep-206/5_stub_node.png)
...
![6_single_tree](./assets/bep-206/6_single_tree.png)
...
![7_two_epoch_tree](./assets/bep-206/7_two_epoch_tree.png)

#### c.Summary
| Mode           | Single Tree                | Two Epoch Trees                                                            | Hybrid Trees                                   |
| -------------- | -------------------------- | -------------------------------------------------------------------------- | ---------------------------------------------- |
| L1 AccountTrie | one global tree            | new tree in each epoch                                                     | one global tree                                |
| L2 StorageTrie | one tree for each contract | new tree in each epoch for each contract                                   | new tree in each epoch for each contract       |
