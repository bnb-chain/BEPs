...
BEP-7 Proposal describes a common set of rules for non-fungible token management within the Binance Chain ecosystem. It introduces the following details of a non-fungible token on Binance Chain:
...
| Amount    | int64    | The amount is positive(unsigned) and can have a maximum of 0 digits(must be an integer) of decimal and is boosted by 1e8 in order to store as int32. |
...
| Amount    | int64    | Frozen amount for this token can have a maximum of 0 digits of decimal(must be an integer), and the value is boosted by 1e8 to store in an int32. This amount should be less than its balance and be positive|
...
| :--------- | :-------- | :------------------------------------------------------------ |
| Symbol    | string   | The symbol should belong to an existing token,e.g. NNB-B90   |
| Amount    | int64    | The unfreeze amount can have a maximum of 0 digits of decimal(must be an integer), and the value is boosted by 1e8 to store in an int32. This amount should be no less than the frozen amount and be positve|
...
| Amount    | int64    | Added supply for this token can have a maximum of 0 digits of decimal(must be an integer), and the value is boosted by 1e8 to store in an int32. The amount before boosting operation should be less than 90 billion after mint. |
...
| :--------- | :-------- | :------------------------------------------------------------ |
| Symbol    | string   | The symbol should belong to an existing token,e.g. NNB-B90   |
| Amount    | int64    | Burnt supply for this token can have a maximum of 0 digits of decimal(must be an integer), and the value is boosted by 1e8 to store in an int32. The amount should be no less than its total supply |
